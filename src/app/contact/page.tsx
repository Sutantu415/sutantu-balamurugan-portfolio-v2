            ...
            {contact?.email && (
              <div>
                ...
                <Link
                  ...
                  className="mt-2 inline-block text-xl text-primary-600 hover:text-primary-500 transition-colors"
                >
                  {contact.email}
                </Link>
              </div>
          ...
          {!contact && (
            <div className="mt-12 rounded-lg bg-gray-50 p-8">
              <p className="text-gray-600">
                Contact information coming soon. In the meantime, feel free to reach out on social media.
              </p>
            </div>
          )}
        </div>
